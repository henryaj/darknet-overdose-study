...
\caption{Forest plot of state-level slope changes ($\beta_3$) for synthetic opioid deaths. Blue points indicate significant deceleration; red points indicate significant acceleration; gray points are not statistically significant. The dashed red line shows the national estimate. Note the extreme heterogeneity: Ohio shows a deceleration of $-$108 deaths/month while Tennessee shows an acceleration of +10 deaths/month.}
\label{fig:forest}
\end{figure}
